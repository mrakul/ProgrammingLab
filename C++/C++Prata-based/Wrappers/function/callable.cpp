...
int main(int argc, char const *argv[])
{
    ...
    //Or not create 6 objects, and create a temporary object for the call:
    typedef std::function<double(double)> fnDblDblTypeDef;
    ...
    cout << "Function pointer square:" << endl;
    cout << " " << useFunction(y, dblDblFunction[1]) << endl;
