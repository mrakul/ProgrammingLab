...
{
    private:
        unsigned int rating;                                                                        // add new member specific to RatedPlayer class only

    public:
        RatedPlayer();
        RatedPlayer(const RatedPlayer &ratedPlayerToCopyConstruct);
        ...
        void resetRating(unsigned int r) { rating = r; }                                            // add a new method specific for the RatedPlayer class only
