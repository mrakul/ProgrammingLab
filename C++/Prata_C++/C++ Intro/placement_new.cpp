...
int main(int argc, char const *argv[])
{
    ...
    ptrObj1 = new (bufPtr) TestingClass;                            // (!!!) Placement new: place a new object at the bufPtr location, but it doesn't allocate a new memory
    ...
    delete ptrObj2;                                                 // This delete has segmentation fault exception
